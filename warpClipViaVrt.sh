...
# echo "***  Create 8 bit tiff --- gdal_translate $sourceChartName"
# nice -10 \
#     ./memoize.py -t \
#         $gdal_root/apps/gdal_translate \
#         -ot Byte -scale  -b 1 -b 2 -b 3 \
#         -strict \
#         -co TILED=YES \
#         -co COMPRESS=DEFLATE \
#         -co PREDICTOR=1 \
...
#         --config GDAL_CACHEMAX 1024 \
#         "$warpedRastersDirectory/$sourceChartName.vrt" \
#         "$warpedRastersDirectory/$sourceChartName-8bit.tif"
        
# echo "***  Create png --- gdal_translate $sourceChartName"
# nice -10 \
#     ./memoize.py \
#         $gdal_root/apps/gdal_translate \
#         -strict \
...
#         --config GDAL_CACHEMAX 1024 \
#         "$warpedRastersDirectory/$sourceChartName.vrt" \
#         "$warpedRastersDirectory/$sourceChartName.png"
# 
# echo "***  quantize --- pngquant $warpedRastersDirectory/$sourceChartName.png"
# nice -10 \
#     ./memoize.py \
#         pngquant "$warpedRastersDirectory/$sourceChartName.png"
